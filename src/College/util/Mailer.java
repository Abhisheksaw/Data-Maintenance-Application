...
public class Mailer {
    ...
    public static void sendMail(Map<String, String> emailCredentials, UserPojo user) throws MessagingException {
        ...
        String emailBody = "Dear " + user.getUserName() + ",\n"
                + "\n"
                + "I hope this email finds you well. I am writing to provide you with the necessary user details as requested. Please find the information below:\n"
                + "\n"
                + "User ID: " + user.getUserId() + "\n"
                + "Branch Name: " + AdminProfile.getBranchName() + "\n"
                + "Email ID: " + user.getEmailId() + "\n"
                + "User password: " + PasswordEncryption.getDecryptedPassword(user.getPassword()) + "\n"
                + "\n"
                + "These details are crucial for internal record-keeping and ensuring efficient communication within the organization.\n"
                + "Best regards,\n"
                + "\n"
                + AdminProfile.getAdminName();
